    ...
    {
      {
        ...
        variants =
        {
          sound_variations("__space-age__/sound/ambient/aquilo/interlude-3/interlude-3-a", 8, 1.4)
        },
...

      {
        ...
        variants =
        {
          sound_variations("__space-age__/sound/ambient/aquilo/interlude-3/interlude-3-b", 19, 1.4)
        },
        composition_mode = "randomized",
      },
    }, --layers
